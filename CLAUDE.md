...
Hệ thống mô phỏng robot nông nghiệp 4WD tự hành. Rules được tổ chức trong `.claude/rules/`.
...
| `robot-architecture.md` | URDF structure, sensors, cấu hình 4WD dual plugin | URDF/hardware files |
...
| 1 — URDF + Gazebo | ✅ Xong |
| 2 — Localization | ✅ Xong |
| 3 — Nav2 + Return-Home | 🔄 Code xong, cần test sau restart Gazebo |
